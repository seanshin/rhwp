...
#### devel — 진행 중 (2026-04-27)

**분석 중**
- TAC 외부 표 안 콘텐츠 클립 — kps-ai p56 회귀 ([#362](https://github.com/edwardkim/rhwp/issues/362))
- exam_eng.hwp 9→8 페이지 회귀 — PR #343 후속 ([#345](https://github.com/edwardkim/rhwp/issues/345))

**계획 중**
- 그림 효과: 밝기/대비 속성 SVG 반영 ([#150](https://github.com/edwardkim/rhwp/issues/150)) — 수행계획서 등록
- 한컴 PDF 기준 Visual Diff 검증 파이프라인 공식 통합 ([#253](https://github.com/edwardkim/rhwp/issues/253))

---

#### 최근 변경 (v0.7.6, 2026-04-26)

**렌더링 품질**
- 비-TAC wrap=위아래 표 out-of-flow 배치 수정 ([#157](https://github.com/edwardkim/rhwp/issues/157)) — Para-relative float 표 텍스트 중첩 해결, PR [#266](https://github.com/edwardkim/rhwp/pull/266) by [@seanshin](https://github.com/seanshin)
- right tab 3경로 선행 공백 처리 통일 ([#267](https://github.com/edwardkim/rhwp/issues/267)) — 목차 페이지 번호 정렬 불일치(~9.33px) 수정, PR [#273](https://github.com/edwardkim/rhwp/pull/273) by [@seanshin](https://github.com/seanshin)
- 목차 리더 도트 + 소제목 페이지 번호 정렬 ([#279](https://github.com/edwardkim/rhwp/issues/279)) — 한컴 동등 수준, PR [#282](https://github.com/edwardkim/rhwp/pull/282) by [@seanshin](https://github.com/seanshin)
- 렌더링 정확도 — Geometric Shapes 전각 처리, TAC 표 선행 텍스트 x좌표 반영, Heavy display face 폭 수정 (외부 기여 by [@planet6897](https://github.com/planet6897) — PR [#256](https://github.com/edwardkim/rhwp/pull/256))
- form-002 인너 표 페이지 분할 결함 해소 (외부 기여 by [@planet6897](https://github.com/planet6897) — PR [#327](https://github.com/edwardkim/rhwp/pull/327))
- typeset 경로 정합 + Task #321~#332 통합 (외부 기여 by [@planet6897](https://github.com/planet6897) — PR [#341](https://github.com/edwardkim/rhwp/pull/341), [#343](https://github.com/edwardkim/rhwp/pull/343))

**API 추가**
- `replaceOne(query, newText, caseSensitive)` WASM API (외부 기여 by [@oksure](https://github.com/oksure) — PR [#334](https://github.com/edwardkim/rhwp/pull/334))
- SVG/HTML `draw_image` 실제 base64 data URI 임베딩 (외부 기여 by [@oksure](https://github.com/oksure) — PR [#335](https://github.com/edwardkim/rhwp/pull/335))

**Firefox 확장 (v0.2.2)**
- AMO 검증 워닝 해소 — manifest strict_min_version 142, viewer 번들 보안 sanitize (외부 기여 by [@postmelee](https://github.com/postmelee) — PR [#339](https://github.com/edwardkim/rhwp/pull/339))

**기여자 감사**
이번 배포 주기에 기여해주신 분들: [@oksure](https://github.com/oksure), [@planet6897](https://github.com/planet6897), [@postmelee](https://github.com/postmelee), [@seanshin](https://github.com/seanshin)
