...
- 793+ 테스트
- Visual diff 테스트 파이프라인 (Hancom PDF 대조 검증)
...
- **Paragraph border/fill**: border_fill background/border with margin-aware positioning
- **Symbol fonts**: Wingdings PUA (U+F000~F0FF) → Unicode standard character mapping
...
| **품질 관문** | 동작하길 바람 | 793 테스트 + Clippy + CI + 코드 리뷰 |
